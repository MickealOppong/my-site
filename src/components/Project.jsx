  ...
  return <article className='w-full'>
    <div className="shadow-2xl w-96 md:w-full
      ...
      <div className='relative' onMouseEnter={() => {
        ...
        <div className={`flex ${showLink ? 'opacity-[100] translate-x-0 duration-300 ' : 'opacity-0 duration-300 '} -translate-Y-full absolute top-[50%] left-[45%] flex-col gap-2  p-2 justify-center items-center z-10 `}>
